...
import { buildMonthlyReportPayload } from "../src/report/buildMonthlyReportPayload";
import { buildMonthlyDiagnosis } from "../src/report/buildMonthlyDiagnosis";
import { buildMonthlyReportText } from "../src/report/buildMonthlyReportText";
...
function main() {
  ...
  const diagnosis = buildMonthlyDiagnosis(payload);
  const reportText = buildMonthlyReportText({
    payload,
    diagnosis,
  });

  writeJsonBoth("monthly_payload", reportDate, payload);
  writeJsonBoth("monthly_diagnosis", reportDate, diagnosis);
